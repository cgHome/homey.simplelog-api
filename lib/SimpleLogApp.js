...
module.exports = class SimpleLogApp extends SimpleClass {
  ...
  constructor(homey, appName) {
    ...
    this.homey = homey;
    this.#appName = appName || this.homey.app.constructor.name;
    ...
    return this.#simpleLogApp.connect();
  }
